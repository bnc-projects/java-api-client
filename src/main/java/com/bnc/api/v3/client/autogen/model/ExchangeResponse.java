...
public class ExchangeResponse {
  ...
  private List<Exchange> content = null;
  
  
  @JsonProperty("nextId")
  private UUID nextId = null;
  
  public ExchangeResponse content(List<Exchange> content) {
    this.content = content;
    return this;
  }

  public ExchangeResponse addContentItem(Exchange contentItem) {
  ...
  **/
  ...
  @Schema(description = "")
  public List<Exchange> getContent() {
    return content;
  }
  public void setContent(List<Exchange> content) {
    this.content = content;
  }
  
  public ExchangeResponse nextId(UUID nextId) {
    this.nextId = nextId;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.content, exchangeResponse.content) &&
        Objects.equals(this.nextId, exchangeResponse.nextId);
  }
